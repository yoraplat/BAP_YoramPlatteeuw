    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.submit}>
          <TextInput style={styles.chatInput} placeholder={'Type je bericht hier'} value={newMessage} onChangeText={(val) => setNewMessage(val)} />
          <TouchableOpacity onPress={() => createMessage()}>
            <FontAwesomeIcon icon={faPaperPlane} size={20} style={{ color: theme.TEXT_PLACEHOLDER }} />
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
