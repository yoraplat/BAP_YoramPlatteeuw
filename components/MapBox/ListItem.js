...
export function ListItem({ title, description, address, pickup, amount, price, hasImage }) {
    ...
    return (
        <View style={styles.listItem}>
            <Text style={styles.title}>{title} <Text style={{ fontFamily: "Poppins_300Light", fontSize: 17 }}>({price})</Text></Text>
            <Text style={styles.description}>{description}</Text>
            <View style={styles.info}>
                <View style={styles.infoList}>
                    <Text style={styles.infoItem}>{pickup}</Text>
                    <Text style={styles.infoItem}>1,3 km</Text>
                    <Text style={styles.infoItem}>{address}</Text>
                    <Text style={[styles.infoItem, { fontFamily: 'Poppins_300Light' }]}>{amount} beschikbaar</Text>
                </View>
